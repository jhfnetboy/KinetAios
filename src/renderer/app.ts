...
function applyTheme(theme: 'dark' | 'light' | 'aurora' | 'serene' | 'tahoe'): void {
...
function readSettingsForm(): AppSettings {
  return {
    ...
    theme: (document.getElementById('s-theme') as HTMLSelectElement).value as 'dark' | 'light' | 'aurora' | 'serene' | 'tahoe',
